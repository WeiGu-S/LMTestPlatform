...
# logger = get_logger("interface_call_dialog")

# class InterfaceCallDialog(QDialog):
...
#         self.init_title_area(main_layout)
#         self.init_form_area(main_layout)
#         self.init_button_area(main_layout)

#     def init_title_area(self, parent_layout):
#         title_frame = QFrame()
